#ifndef SSVO_IMUPREINTEGRATOR_HPP
#define SSVO_IMUPREINTEGRATOR_HPP
...
public:
    ...
    // exponential map from vec3 to matrix3x3 (Rodrigues formula)
...
#endif //SSVO_IMUPREINTEGRATOR_HPP
